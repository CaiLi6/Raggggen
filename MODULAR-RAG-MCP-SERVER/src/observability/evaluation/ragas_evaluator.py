...
class RagasEvaluator(BaseEvaluator):
    ...
    def _build_wrappers(self) -> tuple:
        ...
        openai_compatible_llm_providers = {"openai", "qwen", "deepseek"}
        ...
        elif provider in openai_compatible_llm_providers:
            llm_client_kwargs = {"api_key": llm_cfg.api_key}
        ...
        openai_compatible_embedding_providers = {"openai", "qwen", "deepseek"}
        ...
        elif emb_provider in openai_compatible_embedding_providers:
            emb_client_kwargs = {"api_key": emb_cfg.api_key}
            emb_base_url = getattr(emb_cfg, "base_url", None)
            if emb_base_url:
                emb_client_kwargs["base_url"] = emb_base_url
            emb_client = AsyncOpenAI(**emb_client_kwargs)
        else:
            raise ValueError(
